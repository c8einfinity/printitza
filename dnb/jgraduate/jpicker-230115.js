        ...
        return this.each(function () {
            ...
            var Q = parseFloat(navigator.appVersion.split("MSIE")[1]) < 7 && document.body.filters,
                ...
                V = function () {
					...
					if(svgedit.browser.isIE){console.info("in IE");
									R.get(0).onselectstart = function(event){if (event.target.nodeName.toLowerCase() !== 'input') return false; }}
					else{console.info("in IE else");R.get(0).onselectstart = function(){return false;}}        
