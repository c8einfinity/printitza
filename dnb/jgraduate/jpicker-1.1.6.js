        ...
        I.call(o, r)
            ...
            var q = this,
                ...
                w = function (D) {
					...
					svgCanvas.runExtensions("colorChanged");
                }, t = function (D) {
                    switch (D.keyCode) {
                    case 9:
                    case 16:
        ...
        return this.each(function () {
            ...
            var Q = parseFloat(navigator.appVersion.split("MSIE")[1]) < 7 && document.body.filters,
                ...
                ag = function (aB) {
					...
					svgCanvas.runExtensions("colorSelected", {
						color: G.active.val("ahex")
					});
                }, A = function (az) {
                    ...
                    var az = av.window.element,
                        aA = av.window.page;
                    var J = parseInt(R.css("left"));
                    var I = parseInt(R.css("top"));
                    am = aB.pageX;
                    ai = aB.pageY;
                ...
                V = function () {
					...
					R.get(0).onselectstart = function(event){
                    ...
                    var aK = '<table class="jPicker" cellpadding="0" cellspacing="0"><tbody>' + (aG.expandable ? '<tr><td class="Move" colspan="5">&nbsp;</td></tr>' : "") + '<tr><td rowspan="9"><h2 class="Title">' + (aG.title || aa.text.title) + '</h2><div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><img src="' + n.clientPath + n.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="9"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span><img src="' + n.clientPath + n.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview">' + aa.text.newColor + '<div><span class="Active" title="' + aa.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + aa.tooltips.colors.currentColor + '">&nbsp;</span></div>' + aa.text.currentColor + '</td><td rowspan="9" class="Button"><input type="button" class="Ok dbtn btn-primary" value="' + aa.text.ok + '" title="' + aa.tooltips.buttons.ok + '"/><input type="button" class="Cancel dbtn" value="' + aa.text.cancel + '" title="' + aa.tooltips.buttons.cancel + '"/><hr/><div class="Grid">Recent<br/>&nbsp;</div></td></tr><tr><td class="Radio"><label>C</label></td><td class="TextCustom"><input type="text" id="cyan" maxlength="3" value="" title="" />%</td></tr>  <tr><td class="Radio"><label>M</label></td><td class="TextCustom"><input type="text" id="magenta" maxlength="3" value="" title="" />% </td></tr> <tr><td class="Radio"><label>Y<?label></td><td class="TextCustom"><input type="text" id="yellow" maxlength="3" value="" title="" />% </td></tr><tr><td class="Radio"><label>K</label></td><td class="TextCustom"><input type="text" id="cmyk" maxlength="3" value="" title="" />%<br/><br/></td></tr><tr class="Hue" style="display:none"><td class="Radio"><label title="' + aa.tooltips.hue.radio + '"><input type="radio" value="h"' + (av.color.mode == "h" ? ' checked="checked"' : "") + '/>H:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.h : "") + '" title="' + aa.tooltips.hue.textbox + '"/>&nbsp;&deg;</td></tr><tr class="Saturation" style="display:none"><td class="Radio"><label title="' + aa.tooltips.saturation.radio + '"><input type="radio" value="s"' + (av.color.mode == "s" ? ' checked="checked"' : "") + '/>S:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.s : "") + '" title="' + aa.tooltips.saturation.textbox + '"/>&nbsp;%</td></tr><tr class="Value" style="display:none"><td class="Radio"><label title="' + aa.tooltips.value.radio + '"><input type="radio" value="v"' + (av.color.mode == "v" ? ' checked="checked"' : "") + '/>V:</label><br/><br/></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.v : "") + '" title="' + aa.tooltips.value.textbox + '"/>&nbsp;%<br/><br/></td></tr><tr class="Red"><td class="Radio"><label title="' + aa.tooltips.red.radio + '"><input style="display:none" type="radio" value="r"' + (av.color.mode == "r" ? ' checked="checked"' : "") + '/>R:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.r : "") + '" title="' + aa.tooltips.red.textbox + '"/></td></tr><tr class="Green"><td class="Radio"><label title="' + aa.tooltips.green.radio + '"><input style="display:none" type="radio" value="g"' + (av.color.mode == "g" ? ' checked="checked"' : "") + '/>G:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.g : "") + '" title="' + aa.tooltips.green.textbox + '"/></td></tr><tr class="Blue"><td class="Radio"><label title="' + aa.tooltips.blue.radio + '"><input style="display:none" type="radio" value="b"' + (av.color.mode == "b" ? ' checked="checked"' : "") + '/>B:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (aJ != null ? aJ.b : "") + '" title="' + aa.tooltips.blue.textbox + '"/></td></tr><tr class="Alpha" style="display:none"><td class="Radio">' + (aG.alphaSupport ? '<label title="' + aa.tooltips.alpha.radio + '"><input type="radio" value="a"' + (av.color.mode == "a" ? ' checked="checked"' : "") + "/>A:</label>" : "&nbsp;") + '</td><td class="Text">' + (aG.alphaSupport ? '<input type="text" maxlength="' + (3 + aG.alphaPrecision) + '" value="' + (aJ != null ? Math.precision((aJ.a * 100) / 255, aG.alphaPrecision) : "") + '" title="' + aa.tooltips.alpha.textbox + '"/>&nbsp;%' : "&nbsp;") + '</td></tr><tr class="Hex"><td class="Radio"><label title="' + aa.tooltips.hex.textbox + '">Hex#:</label></td><td class="Text"><input type="text" maxlength="6" class="Hex" value="' + (aJ != null ? aJ.hex : "") + '"/>' + (aG.alphaSupport ? '<input type="text" maxlength="2" class="AHex" style="display:none" value="' + (aJ != null ? aJ.ahex.substring(6) : "") + '" title="' + aa.tooltips.hex.alpha + '"/></td></td>' : "&nbsp;") + "</tr></tbody></table>";
                    if (aG.expandable) {
                        R.html(aK);
                    ...
                    if (G.quickList && G.quickList.length > 0) {
                        var aE = "";
                        for (var i = 0; i < G.quickList.length; i++) {
			...
			svgCanvas.runExtensions("pickerOpen");
        });
    };
