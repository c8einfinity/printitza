 ...
 */
    ...
    class QRvect {
        ...
        private static function vectSVG($frame, $pixelPerPoint = 4, $outerFrame = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000) 
        {
            ...
            if(!empty($back_color)) {
                $backgroundcolor = str_pad($back_color, 6, "0");
			...
			if($fore_color == '0')
			{
				$output .= '<g fill="#000000">'."\n";
			}
			else
			{
			   $output .= '<g fill="#'.str_pad($fore_color, 6, "0").'">'."\n"; 
			}
            ...
            for($i=0; $i<$h; $i++) {
                for($j=0; $j<$w; $j++) {
                    if( $frame[$i][$j] == '1') {
                        ...
                        $output .= '<rect width="'.$pixelPerPoint.'" height="'.$pixelPerPoint.'" x="'.$x.'" y="'.$y.'" />'."\n";
                    }
                }
            }
            $output .= 
