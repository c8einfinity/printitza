...
class FrontendOptionsEditActionControllerSaveObserver implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        foreach ($this->_storeCollection as $store) {
            ...
            $content = $this->_generateContent($frontendOptions, $fontFamilyOptions, $store->getId());
     ...
     * @return string
     */
    private function _generateContent($frontendOptions, $fontFamilyOptions, $storeId)
    {
        $content = '// Generated Less from WeltPixel_FrontendOptions' . PHP_EOL;
        ...
        $PrimaryMainColor = $this->_helper->getPrimaryMainColor($storeId);
        $SecondaryMainColor = $this->_helper->getSecondaryMainColor($storeId);
        $DefaultTextColor = $this->_helper->getDefaultTextColor($storeId);
        $productpageActionButtonVersionTwo = $this->_helper->getProductpageActionButtonVersionTwo($storeId);
        $productpageActionButtonHoverVersionTwo = $this->_helper->getProductpageActionButtonHoverVersionTwo($storeId);
        $productpageActionButtonTextVersionTwo = $this->_helper->getProductpageActionButtonTextVersionTwo($storeId);
        $productpageActionButtonTextHoverVersionTwo = $this->_helper->getProductpageActionButtonTextHoverVersionTwo($storeId);
        ...
        $content .= "
            .footer-top-newsletter{
                ...
                button{
                    &:hover{
                        border:2px solid $PrimaryMainColor !important;
            ...
            .product-accordion-box {
                ...
                #product-enquiry-button{
                    &.action.primary{
                        background:$productpageActionButtonVersionTwo;
                        border-color:$productpageActionButtonVersionTwo;
                        color:$productpageActionButtonTextVersionTwo;
                        > span{
                            color:$productpageActionButtonTextVersionTwo;
                        }
                        &:hover{
                            background:$productpageActionButtonHoverVersionTwo;
                            border-color:$productpageActionButtonHoverVersionTwo;
                            color:$productpageActionButtonTextHoverVersionTwo;
                            > span{
                                color:$productpageActionButtonTextHoverVersionTwo;
                            }
                        }
