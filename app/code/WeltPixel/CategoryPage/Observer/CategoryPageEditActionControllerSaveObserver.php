...
.canvas_icons {
    ...
    {
        $width = (100 / $productsPerLine) - 2;
        $productsPerLinePV = $productsPerLine + 1;
        $widthPV = (100 / $productsPerLinePV) - 2;
...
@media (min-width: $breakPoint), print {
    ...
    .page-products .grid.products-grid .product-items{";
        switch ($productsPerLine) {
            case 2:
               $content .= "
                   margin: 0 0 0 calc(~\"(100% - $productsPerLine * $width%) / -$productsPerLine\") !important;
                ";
                break;
            case 3:
            $content .= "
    ...
    .catalog-product-view .grid.products-grid .product-items{margin-left:-5px !important;}
    ...
    .catalog-product-view.page-layout-1column .grid.products-grid .owl-item .product-item { width: 100% !important; margin: 0; }
}
        ";
        return $content;
    }
