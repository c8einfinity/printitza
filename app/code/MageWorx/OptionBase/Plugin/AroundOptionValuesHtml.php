...
class AroundOptionValuesHtml
{
    ...
    public function aroundGetValuesHtml(Select $subject, \Closure $proceed)
    {
        ...
        foreach ($option->getValues() as $value) {
            ...
            if ($element) {
                $element->setAttribute("data-option_type_id", $value->getMageworxOptionTypeId());
                $element->setAttribute("my_type",$option->getTitle());
                $element->setAttribute("ttl_qty",$value->getTitle());
            }
        }
