...
class OptionAdvancedPricing extends AbstractModifier implements ModifierInterface
{
    ...
    {
        $field[static::OPTION_VALUE_SPECIAL_PRICE] = [
            'arguments' => [
                'data' => [
                    'config' => [
    ...
    {
        $field[static::OPTION_VALUE_TIER_PRICE] = [
            'arguments' => [
                'data' => [
                    'config' => [
                        'componentType' => Field::NAME,
    ...
    protected function getPriceStructures()
    {
        $data = [];
        if ($this->helper->isSpecialPriceEnabled()) {
            $data[static::OPTION_VALUE_SPECIAL_PRICE] = $this->getSpecialPriceStructure();
        }
        if ($this->helper->isTierPriceEnabled()) {
            $data[static::OPTION_VALUE_TIER_PRICE] = $this->getTierPriceStructure();
        }
        return $data;
    }
