    ...
    return ModalComponent.extend({
        ...
        initSpecialPrice: function () {
            ...
            this.specialPriceDynamicRows = registry.get(
                this.formName + '.' + this.formName + '.' + this.dynamicRowsPath + '.special_price'
            );
            ...
            if (this.isSchedule === true) {
                registry.get(this.productEntityProvider)
                    .set(this.dynamicRowsDataScope + '.special_price', specialPriceData);
            } else {
                registry.get(this.entityProvider).set(this.dynamicRowsDataScope + '.special_price', specialPriceData);
            }
        ...
        initTierPrice: function () {
            ...
            this.tierPriceDynamicRows = registry.get(
                this.formName + '.' + this.formName + '.' + this.dynamicRowsPath + '.tier_price'
            );
            ...
            if (this.isSchedule === true) {
                registry.get(this.productEntityProvider)
                    .set(this.dynamicRowsDataScope + '.tier_price', tierPriceData);
            } else {
                registry.get(this.entityProvider).set(this.dynamicRowsDataScope + '.tier_price', tierPriceData);
            }
