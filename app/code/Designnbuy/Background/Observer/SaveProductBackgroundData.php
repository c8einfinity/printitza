 ...
 * Background observer
 */
class SaveProductBackgroundData implements ObserverInterface
{
    /**
    ...
    public function __construct(
        ...
        \Designnbuy\Background\Model\ResourceModel\Background\Product $product
    ) {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $request = $this->_request;
        $links = $this->_request->getParam('links');
        $links = isset($links) ? $links : ['background' => []];
