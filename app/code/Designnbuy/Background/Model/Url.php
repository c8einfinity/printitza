...
class Url
{
     ...
     * Objects Types
     */
    const CONTROLLER_CLIPART = 'background';
     ...
     * @return string
     */
    public function getBackgroundImageMediaUrl($file)
    {
        return $this->_storeManager->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . Background::BASE_MEDIA_PATH . DIRECTORY_SEPARATOR . $file;
    }
     ...
     * @return string
     */
    public function getBackgroundImagesMediaUrl($file)
    {
        return $this->_storeManager->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . Background::BACKGROUND_IMAGES_MEDIA_PATH . DIRECTORY_SEPARATOR . '/' . $file;
    }

    /**
     * Retrieve background permalink config value
     * @param  string $key
