 ...
 * Tag model
 *
 * @method \Designnbuy\Background\Model\ResourceModel\Tag _getResource()
 * @method \Designnbuy\Background\Model\ResourceModel\Tag getResource()
...
class Tag extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'designnbuy_background_tag';
     ...
     * @var string
     */
    protected $_eventObject = 'background_tag';
    ...
    {
        $this->_init('Designnbuy\Background\Model\ResourceModel\Tag');
    }
