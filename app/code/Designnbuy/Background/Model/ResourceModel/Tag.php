...
class Tag extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('designnbuy_background_tag', 'tag_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('designnbuy_background_background_tag'), $condition);*/
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $identifierGenerator = \Magento\Framework\App\ObjectManager::getInstance()
                ->create('Designnbuy\Background\Model\ResourceModel\PageIdentifierGenerator');
