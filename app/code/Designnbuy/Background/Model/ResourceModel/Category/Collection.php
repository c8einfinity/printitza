...
namespace Designnbuy\Background\Model\ResourceModel\Category;

/**
 * Background category collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Designnbuy\Background\Model\Category', 'Designnbuy\Background\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('designnbuy_background_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('designnbuy_background_category_store')],
