...
namespace Designnbuy\Background\Block\Background\BackgroundList\Toolbar;

use Designnbuy\Background\Model\Config\Source\LazyLoad;

/**
 * Background backgrounds list toolbar pager
 */
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbbackground/background_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbbackground/background_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
