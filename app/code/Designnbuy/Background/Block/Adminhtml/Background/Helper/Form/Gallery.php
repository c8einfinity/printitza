 ...
 */
namespace Designnbuy\Background\Block\Adminhtml\Background\Helper\Form;
...
class Gallery extends \Magento\Framework\View\Element\AbstractBlock
{
     ...
     * @var string
     */
    protected $fieldNameSuffix = 'background';
     ...
     * @var string
     */
    protected $formName = 'background_background_form';
