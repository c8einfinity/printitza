...
namespace Designnbuy\Designidea\Block\Adminhtml\Category;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
   ...
   // private $_status;
     ...
     *
     * @param \Magento\Backend\Block\Designidea\Context                                   $context
     * @param \Magento\Backend\Helper\Data                                              $backendHelper
     * @param \Designnbuy\Designidea\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinAttribute('title','designnbuy_designidea_category/title','entity_id',null,'left',$adminStoreId);
        $collection->joinAttribute('status','designnbuy_designidea_category/status','entity_id',null,'left',$adminStoreId);
