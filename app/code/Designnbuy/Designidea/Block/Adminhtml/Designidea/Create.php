...
{
    protected $_template = 'designidea/create.phtml';
    /**
    ...
    public function getIframeUrl() {
        ...
        return $this->getUrl('designidea/designidea/tool').'?'.http_build_query($this->getRequest()->getParams());
        //return $this->getUrl('designidea/designidea/tool', $params);
