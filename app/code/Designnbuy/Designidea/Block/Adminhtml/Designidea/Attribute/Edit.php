 ...
 *
 */
namespace Designnbuy\Designidea\Block\Adminhtml\Designidea\Attribute;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Designnbuy_Designidea';
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_designidea_attribute';
        ...
        if (!$entityAttribute || !$entityAttribute->getIsUserDefined()
                || !$this->_isAllowedAction('Designnbuy_Designidea::attribute_delete')) {
    ...
    public function getHeaderText()
    {
       if ($this->_coreRegistry->registry('customer_attribute')->getId()) {
            ...
            return __('Edit Editable Artwork Attribute "%1"', $this->escapeHtml($frontendLabel));
        }
        return __('New Editable Artwork Attribute');
    }
