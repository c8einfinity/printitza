...
namespace Designnbuy\Designidea\Block\Adminhtml\Designidea\Edit\Tab;
...
//class Form extends \Magento\Catalog\Block\Adminhtml\Form
{
    ...
    {
        return [
            'image' => 'Designnbuy\Designidea\Block\Adminhtml\Designidea\Helper\Image'
        ];
    }
    ...
    {
        $designidea = $this->getCurrentDesignidea();
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Editable Artwork Details')]);

        $attributes = $this->getAttributes();

        $entity = $this->getEavConfig()->getEntityType(\Designnbuy\Designidea\Model\Designidea::ENTITY)->getEntity();
    ...
    {
        return $this->_coreRegistry->registry('current_designidea');
    }
