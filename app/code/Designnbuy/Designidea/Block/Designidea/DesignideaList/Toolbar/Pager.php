...
namespace Designnbuy\Designidea\Block\Designidea\DesignideaList\Toolbar;

use Designnbuy\Designidea\Model\Config\Source\LazyLoad;

/**
 * Designidea designideas list toolbar pager
 */
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbdesignidea/designidea_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbdesignidea/designidea_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
