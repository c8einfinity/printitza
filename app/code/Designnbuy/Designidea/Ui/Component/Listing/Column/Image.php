<?php
namespace Designnbuy\Designidea\Ui\Component\Listing\Column;
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if(isset($item) && !empty($item['image'])){
                    $imagePath = $this->_url->getMediaUrl('designnbuy/designidea/'.$item['image']);//$mediaRelativePath.$item['image'];
