...
class PersonaliseOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
        ...
        $data[$productId][self::DATA_SOURCE_DEFAULT]['designs'] = [];
        return $data;
    }
    ...
    protected function customizePersonalisationOptions()
    {
        ...
        $this->meta['advanced_design_modal']['arguments']['data']['config'] = [
            'component' => 'Designnbuy_Designidea/js/components/modal-component',
            'isTemplate' => false,
            'componentType' => Modal::NAME,
            'dataScope' => '',
            'provider' => 'product_form.product_form_data_source',
            'indexies' => [
                'designidea_dynamic_row' => 'designs',
            ],
            'onCancel' => 'actionDone',
            'options' => [
                'title' => __('Set Default Design Template'),
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Design Ideas'),
                        'columnsHeader' => true,
                        'columnsHeaderAfterRender' => true,
                        'dependencyContainer' => 'designidea_hidden_dependency',
                        'component' => 'Designnbuy_Designidea/js/components/dynamic-rows',
                        'componentType' => 'dynamicRows',
