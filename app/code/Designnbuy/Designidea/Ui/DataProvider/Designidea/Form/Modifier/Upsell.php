 ...
 */
class Upsell extends AbstractModifier
{
    const DATA_SCOPE = '';
    ...
    {
        /** @var \Designnbuy\Designidea\Model\Designidea $designidea */
        ...
        $items = [];
        $collection = $designidea->getUpsellDesignIdeas();
        ...
        $data[$designIdeaId]['links']['upsell'] = $items;

        $data[$designIdeaId]['current_designidea_id'] = $designIdeaId;
        $data[$designIdeaId]['current_store_id'] = $this->locator->getStore()->getId();
