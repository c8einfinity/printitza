...
use \Designnbuy\Designidea\Model\Category as CategoryModel;
use Magento\Framework\UrlInterface;
use Magento\Framework\Stdlib\ArrayManager;

/**
 * Data provider for categories field of designidea page
...
class Categories extends AbstractModifier
{
     ...
     */
    const CATEGORY_TREE_ID = 'DESIGNIDEA_CATEGORY_TREE';
    /**#@-*/
                            ...
                            'data' => [
                                'config' => [
                                    ...
                                    'render_url' => $this->urlBuilder->getUrl(
                                        ...
                                        [
                                            'handle' => 'designidea_category_create',
                                            'store' => $this->locator->getStore()->getId(),
                                            'buttons' => 1
                                        ]
                                    ),
                                    'autoRender' => false,
                                    'ns' => 'designidea_category_new_category_form',
                                    'externalProvider' => 'designidea_category_new_category_form.designidea_category_new_category_form_data_source',
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    'formElement' => 'select',
                                    //'componentType' => 'field',
                                    'component' => 'Designnbuy_Background/js/components/new-category',
//                                    'component' => 'Designnbuy_Designidea/js/components/new-category',
                                    'filterOptions' => true,
                                    'chipsEnabled' => true,
                                    'disableLabel' => true,
                                    'multiple' => true,
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'actions' => [
                                        [
                                            'targetName' => 'designidea_form.designidea_form.create_category_modal',
                                            'actionName' => 'toggleModal',
                                        ],
                                        [
                                            'targetName' =>
                                                'designidea_form.designidea_form.create_category_modal.create_category',
                                            'actionName' => 'render'
                                        ],
                                        [
                                            'targetName' =>
