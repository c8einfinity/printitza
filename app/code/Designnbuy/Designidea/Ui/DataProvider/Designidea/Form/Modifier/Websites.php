...
class Websites extends AbstractModifier
{
    ...
    {
        $modelId = $this->locator->getDesignIdea()->getId();
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'label' => __('Editable Artwork in Websites'),
                                    'collapsible' => true,
    ...
    protected function getFieldsForFieldset()
    {
        ...
        $isNewProduct = !$this->locator->getDesignIdea()->getId();
        $tooltip = [
    ...
    /**
     * Return array of websites ids, assigned to the designidea
     *
     * @return array
     */
    protected function getWebsitesValues()
    {
        return $this->locator->getDesignIdeaWebsiteIds();
    }
}
