...
class View extends \Designnbuy\Designidea\App\Action\Action
{
    ...
    /**
     * View designidea category action
     *
    ...
    public function execute()
    {
        ...
        $this->_objectManager->get('\Magento\Framework\Registry')
            ->register('current_designidea_category', $category);
     ...
     * Init category
     *
     * @return \Designnbuy\Designidea\Model\category || false
     */
    protected function _initCategory()
    {
        ...
        $category = $this->_objectManager->create('Designnbuy\Designidea\Model\Category')->load($id);
