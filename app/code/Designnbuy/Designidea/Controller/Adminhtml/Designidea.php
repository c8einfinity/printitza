 ...
 */
abstract class Designidea extends \Designnbuy\Designidea\Controller\Adminhtml\AbstractAction
{
    const PARAM_ID = 'id';
    ...
    {
        return $this->_authorization->isAllowed('Designnbuy_Designidea::designidea');
    }
}
