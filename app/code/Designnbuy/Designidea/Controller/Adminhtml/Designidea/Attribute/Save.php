<?php
/**
 * Designidea attribute save controller
 * 
 */
 ...
 */
class Save extends \Designnbuy\Designidea\Controller\Adminhtml\Designidea\Attribute\Attribute
{
    /**
     ...
     * @param \Designnbuy\Designidea\Helper\Data $attributeHelper
    ...
    public function __construct(
        ...
        \Designnbuy\Designidea\Helper\Data $attributeHelper,
...
//            }
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('designidea/designidea_attribute/*/', [], ['error' => true]);
                }
            ...
            $defaultAttributeSetId = $this->_objectManager->get('Magento\Eav\Model\Config')
                    ->getEntityType(\Designnbuy\Designidea\Model\Designidea\Attribute::ENTITY)
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the editable artwork attribute.'));

                $this->_session->setAttributeData(false);
                if ($this->getRequest()->getParam('back', false)) {
                    return $this->returnResult(
                        'designidea/designidea_attribute/edit',
                        ['attribute_id' => $model->getId(), '_current' => true],
                        ['error' => false]
                    );
                }
                return $this->returnResult('designidea/attribute/*/', [], ['error' => false]);
            } catch (\Exception $e) {
