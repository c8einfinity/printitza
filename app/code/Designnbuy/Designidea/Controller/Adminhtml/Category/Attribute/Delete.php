...
class Delete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Designnbuy_Designidea::attribute_delete');
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                $model = $this->_objectManager->create('Designnbuy\Designidea\Model\ResourceModel\Eav\Attribute');
                $model->load($id);
                $model->delete();
