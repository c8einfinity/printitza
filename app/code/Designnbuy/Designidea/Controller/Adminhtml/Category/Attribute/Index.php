...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Editable Artwork Category Attribute'), __('Editable Artwork Category'));
        $resultPage->addBreadcrumb(__('Manage Editable Artwork Attribute'), __('Editable Artwork Category Attributes'));
    ...
    {
        return $this->_authorization->isAllowed('Designnbuy_Designidea::category_attributes');
    }
}