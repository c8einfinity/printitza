 ...
 */
class Save extends \Designnbuy\Designidea\Controller\Adminhtml\Category\Attribute\Attribute
{
    /**
...
//            }
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('designidea/category_attribute/*/', [], ['error' => true]);
                }
            ...
            $defaultAttributeSetId = $this->_objectManager->get('Magento\Eav\Model\Config')
                    ->getEntityType(\Designnbuy\Designidea\Model\Category\Attribute::ENTITY)
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the editable artwork category attribute.'));

                $this->_session->setAttributeData(false);
                if ($this->getRequest()->getParam('back', false)) {
                    return $this->returnResult(
                        'designidea/category_attribute/edit',
