 ...
 * Background observer
 */
class SaveDesignideaCategoryData implements ObserverInterface
{
    /**
    ...
    public function __construct(
        ...
        \Designnbuy\Designidea\Model\ResourceModel\Category\Product $product
    ) {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $links = isset($links) ? $links : ['designidea_category' => []];

        //$links = isset($links['links']) ? $links['links'] : ['printingmethod' => []];
        if (is_array($links)) {
            foreach (['designidea_category'] as $linkType) {
