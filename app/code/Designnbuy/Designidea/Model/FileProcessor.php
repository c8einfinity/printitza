...
class FileProcessor
{
    ...
    {
        $filePath = \Designnbuy\Designidea\Helper\Designidea::BASE_MEDIA_PATH . '/' . ltrim($fileName, '/');
    ...
    public function getViewUrl($filePath, $type)
    {
        $viewUrl = '';
            ...
            $filePath = \Designnbuy\Designidea\Helper\Designidea::BASE_MEDIA_PATH . '/' . ltrim($filePath, '/');
    ...
    public function saveTemporaryFile($fileId)
    {
        ...
        $path = $this->mediaDirectory->getAbsolutePath(
            \Designnbuy\Designidea\Helper\Designidea::BASE_MEDIA_PATH . '/' . self::TMP_DIR
        );
