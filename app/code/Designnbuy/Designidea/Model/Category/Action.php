...
class Action extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init(\Designnbuy\Designidea\Model\ResourceModel\Category\Action::class);
    }
     ...
     * @return $this
     */
    public function updateAttributes($categoryIds, $attrData, $storeId)
    {
        $this->_getResource()->updateAttributes($categoryIds, $attrData, $storeId);
        /*$this->setData(
