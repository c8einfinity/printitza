 ...
 */
namespace Designnbuy\Designidea\Model\Category\Attribute;
 ...
 */
class Repository implements \Designnbuy\Designidea\Api\Category\CategoryAttributeRepositoryInterface
{
    /**
    ...
    public function get($attributeCode)
    {
        return $this->eavAttributeRepository->get(
            \Designnbuy\Designidea\Api\Data\Category\CategoryAttributeInterface::ENTITY_TYPE_CODE,
            $attributeCode
        );
    }
