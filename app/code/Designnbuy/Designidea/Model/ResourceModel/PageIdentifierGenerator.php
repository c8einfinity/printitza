...
class PageIdentifierGenerator
{
    ...
    public function generate(\Magento\Framework\Model\AbstractModel $object)
    {
       ...
       /* if ($object->getData('identifier')) {
            ...
            $designidea->checkIdentifier($identifier, $this->getStoreId());
        }*/
        ...
        while (true) {
            ...
            $designideaId = $designidea->checkIdentifier($finalIdentifier, $this->getStoreId());
            $categoryId = $category->checkIdentifier($finalIdentifier, $this->getStoreId(), $object->getWebsiteIds($object));
            if (!$designideaId && !$categoryId) {
                break;
            } else {
                if ($designideaId
                    && $designideaId == $object->getId()
                    && $object instanceof \Designnbuy\Designidea\Model\Designidea
                ) {
                    break;
                }
                ...
                if ($categoryId
                    ...
                    && $object instanceof \Designnbuy\Designidea\Model\Category
                ) {
                    break;
                }
            }
