...
namespace Designnbuy\Designidea\Model\ResourceModel\Category\Eav;
...
class Attribute extends \Magento\Eav\Model\Entity\Attribute implements
    \Designnbuy\Designidea\Api\Data\Category\CategoryAttributeInterface, \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface
{
    const MODULE_NAME = 'Designnbuy_Designidea';
    ...
    {
        $this->_init('Designnbuy\Designidea\Model\ResourceModel\Category\Attribute');
    }
