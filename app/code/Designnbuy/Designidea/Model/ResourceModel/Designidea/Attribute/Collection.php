 ...
 */
namespace Designnbuy\Designidea\Model\ResourceModel\Designidea\Attribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
    ...
    protected function _initSelect()
    {
        $entityTypeId = (int)$this->_eavEntityFactory->create()->setType(
            \Designnbuy\Designidea\Model\Designidea::ENTITY
        )->getTypeId();
        ...
        $this->getSelect()->from(
            ...
            ['additional_table' => $this->getTable('designnbuy_designidea_eav_attribute')],
