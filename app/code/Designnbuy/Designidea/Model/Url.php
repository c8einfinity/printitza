...
class Url
{
     ...
     * Objects Types
     */
    const CONTROLLER_DESIGNIDEA = 'designidea';
    ...
    /**
     * Retrieve designidea permalink config value
     * @param  string $key
