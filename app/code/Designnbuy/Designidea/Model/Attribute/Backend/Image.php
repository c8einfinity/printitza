 ...
 */
namespace Designnbuy\Designidea\Model\Attribute\Backend;
...
class Image extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    ...
    public function __construct(
        \Designnbuy\Designidea\Helper\Designidea $designideaHelper,
    ...
    public function afterSave($object)
    {
        ...
        try {
            /*$path = $this->_filesystem->getDirectoryRead(DirectoryList::MEDIA)
                ->getAbsolutePath(\Designnbuy\Designidea\Helper\Designidea::BASE_MEDIA_PATH);

            $uploader = $this->_fileUploaderFactory->create(['fileId' => "designidea[".$this->getAttribute()->getName()."]"]);
    ...
    private function getImageUploader()
    {
        if ($this->imageUploader === NULL) {
            ...
            $this->imageUploader->setBasePath('designnbuy/designidea');
        }
