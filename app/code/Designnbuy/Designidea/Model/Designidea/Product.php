...
class Product extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Designnbuy\Designidea\Model\ResourceModel\Designidea\Product\CollectionFactory $designIdeaProductCollectionFactory,
    ...
    {
        $this->_init('Designnbuy\Designidea\Model\ResourceModel\Designidea\Product');
    }
     ...
     */
    public function getProductCollection($designIdea)
    {
        $collection = $this->getCollection()->addDesignIdeaFilter($designIdea);
        return $collection;
    }
}
