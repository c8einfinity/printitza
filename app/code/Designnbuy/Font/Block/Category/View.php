...
namespace Designnbuy\Font\Block\Category;
 ...
 * Font category view
 */
class View extends \Designnbuy\Font\Block\Font\FontList
{
    /**
    ...
    {
        return $this->_coreRegistry->registry('current_font_category');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        if ($category) {
            ...
            $this->pageConfig->addBodyClass('font-category-' . $category->getIdentifier());
    ...
    protected function _addBreadcrumbs($title = null, $key = null)
    {
        ...
        if ($breadcrumbsBlock = $this->getBreadcrumbsBlock()) {
            ...
            for ($i = count($parentCategories) - 1; $i >= 0; $i--) {
                ...
                $breadcrumbsBlock->addCrumb('font_parent_category_' . $category->getId(), [
            ...
            $breadcrumbsBlock->addCrumb('font_category',[
                'label' => $category->getTitle(),
                'title' => $category->getTitle()
            ]);
        }
