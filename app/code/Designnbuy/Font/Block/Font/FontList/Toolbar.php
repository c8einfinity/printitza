...
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'font/list/toolbar.phtml';
    ...
    /**
     * Get specified fonts limit display per page
     *
     * @return string
     */
    public function getLimit()
    {
        return $this->_scopeConfig->getValue(
            'dnbfont/font_list/fonts_per_page', 
    ...
    {
        $pagerBlock = $this->getChildBlock('font_list_toolbar_pager');
