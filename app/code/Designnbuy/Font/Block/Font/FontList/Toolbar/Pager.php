...
namespace Designnbuy\Font\Block\Font\FontList\Toolbar;

use Designnbuy\Font\Model\Config\Source\LazyLoad;

/**
 * Font fonts list toolbar pager
 */
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbfont/font_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbfont/font_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
