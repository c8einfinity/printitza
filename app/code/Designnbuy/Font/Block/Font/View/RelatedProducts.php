...
/**
 * Font font related products block
 */
    ...
    implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_itemCollection = $font->getRelatedProducts()
        ...
        $this->_itemCollection->setPageSize(
            (int) $this->_scopeConfig->getValue(
                'dnbfont/font_view/related_products/number_of_products',
    ...
    public function displayProducts()
    {
        return (bool) $this->_scopeConfig->getValue(
            'dnbfont/font_view/related_products/enabled',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        $font = $this->getFont();
        return $font ? [ \Magento\Cms\Model\Page::CACHE_TAG . '_relatedproducts_' . $font->getId() ] : [];
    }
}
