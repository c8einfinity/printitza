...
class PermalinkType implements \Magento\Framework\Option\ArrayInterface
{
    ...
    {
        return [
            ['value' => Url::PERMALINK_TYPE_DEFAULT, 'label' => __('Default: mystore.com/{font_route}/{font_route}/font-title/')],
            ['value' => Url::PERMALINK_TYPE_SHORT, 'label' => __('Short: mystore.com/{font_route}/font-title/')],
        ];
    }
