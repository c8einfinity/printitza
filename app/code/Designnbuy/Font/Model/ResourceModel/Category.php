...
class Category extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('designnbuy_font_category', 'category_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('designnbuy_font_category_store'), $condition);
        $this->getConnection()->delete($this->getTable('designnbuy_font_font_category'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('designnbuy_font_category_store');
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds, $isActive = null)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('designnbuy_font_category_store')],
    ...
    public function lookupStoreIds($categoryId)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('designnbuy_font_category_store'),
            'store_id'
        )->where(
            'category_id = ?',
            (int)$categoryId
    ...
    {
        $deleteByStoreIds = [];
        $table = $this->getTable('designnbuy_font_category_label');
    ...
    {
        $select = $this->getConnection()->select()->from(
            $this->getTable('designnbuy_font_category_label'),
            ['store_id', 'label']
        )->where(
