...
namespace Designnbuy\Font\Model\ResourceModel\Category;

/**
 * Font category collection
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Designnbuy\Font\Model\Category', 'Designnbuy\Font\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('designnbuy_font_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('designnbuy_font_category_store')],
