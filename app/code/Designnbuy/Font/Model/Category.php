 ...
 * Category model
 *
 * @method \Designnbuy\Font\Model\ResourceModel\Category _getResource()
 * @method \Designnbuy\Font\Model\ResourceModel\Category getResource()
...
class Category extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'designnbuy_font_category';
     ...
     * @var string
     */
    protected $_eventObject = 'font_category';
    ...
    {
        $this->_init('Designnbuy\Font\Model\ResourceModel\Category');
    }
    ...
    {
        return $plural ? 'Font Categories' : 'Font Category';
    }
    ...
    /**
     * Retrieve number of fonts in this category
     *
     * @return int
     */
    public function getFontsCount()
    {
        ...
        if (!$this->hasData($key)) {
            ...
            $fonts = $this->fontCollectionFactory->create()
                ->addActiveFilter()
            ...
            $this->setData($key, (int)$fonts->getSize());
        }
