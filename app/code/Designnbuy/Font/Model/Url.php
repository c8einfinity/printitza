...
class Url
{
    ...
    public function getMediaUrl($file)
    {
        return $this->_storeManager->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . Font::BASE_MEDIA_PATH . DIRECTORY_SEPARATOR . $file;
    }

    /**
     * Retrieve font permalink config value
     * @param  string $key
