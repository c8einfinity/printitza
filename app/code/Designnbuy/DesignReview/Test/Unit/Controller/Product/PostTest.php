 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Controller\Product;
...
class PostTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Designnbuy\DesignReview\Controller\Product\Post
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $reviewFactory = $this->createPartialMock(\Designnbuy\DesignReview\Model\ReviewFactory::class, ['create']);
        ...
        $ratingFactory = $this->createPartialMock(\Designnbuy\DesignReview\Model\RatingFactory::class, ['create']);
        ...
        $this->model = $objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Controller\Product\Post::class,
            [
    ...
    public function testExecute()
    {
        ...
        $this->review->expects($this->once())->method('getEntityIdByCode')
            ->with(\Designnbuy\DesignReview\Model\Review::ENTITY_PRODUCT_CODE)
            ->willReturn(1);
        ...
        $this->review->expects($this->once())->method('setStatusId')
            ->with(\Designnbuy\DesignReview\Model\Review::STATUS_PENDING)
            ->willReturnSelf();
