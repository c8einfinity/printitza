...
{
    /** @var \Designnbuy\DesignReview\Model\Review */
    protected $review;
    ...
    /** @var \Designnbuy\DesignReview\Model\Review\Summary|\PHPUnit_Framework_MockObject_MockObject */
    ...
    /** @var \Designnbuy\DesignReview\Model\ResourceModel\Review|\PHPUnit_Framework_MockObject_MockObject */
    protected $resource;
    ...
    protected function setUp()
    {
        ...
        $this->productFactoryMock = $this->createPartialMock(
            \Designnbuy\DesignReview\Model\ResourceModel\Review\Product\CollectionFactory::class,
            ['create']
        );
        $this->statusFactoryMock = $this->createPartialMock(
            \Designnbuy\DesignReview\Model\ResourceModel\Review\Status\CollectionFactory::class,
            ['create']
        );
        $this->reviewSummaryMock = $this->createMock(
            \Designnbuy\DesignReview\Model\ResourceModel\Review\Summary\CollectionFactory::class
        );
        $this->summaryModMock = $this->createPartialMock(
            \Designnbuy\DesignReview\Model\Review\SummaryFactory::class,
            ['create']
        );
        $this->summaryMock = $this->createMock(\Designnbuy\DesignReview\Model\Review\Summary::class);
        $this->storeManagerMock = $this->createMock(\Magento\Store\Model\StoreManagerInterface::class);
        $this->urlInterfaceMock = $this->createMock(\Magento\Framework\UrlInterface::class);
        $this->resource = $this->createMock(\Designnbuy\DesignReview\Model\ResourceModel\Review::class);
    ...
    {
        $collection = $this->createMock(\Designnbuy\DesignReview\Model\ResourceModel\Review\Product\Collection::class);
    ...
    {
        $collection = $this->createMock(\Designnbuy\DesignReview\Model\ResourceModel\Review\Status\Collection::class);
