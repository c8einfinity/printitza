...
namespace Designnbuy\DesignReview\Test\Unit\Model\ResourceModel\Review\Summary;

use Designnbuy\DesignReview\Model\ResourceModel\Review\Summary\Collection;
...
class CollectionTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->collection = $objectManager->getObject(
            \Designnbuy\DesignReview\Model\ResourceModel\Review\Summary\Collection::class,
            [
    ...
    public function testFetchItem()
    {
        ...
        $this->entityFactoryMock->expects($this->once())
            ->method('create')
            ->with(\Designnbuy\DesignReview\Model\Review\Summary::class)
