 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Model\ResourceModel\Review;

class CollectionTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Designnbuy\DesignReview\Model\ResourceModel\Review\Collection
     */
    protected $model;
    ...
    protected function setUp()
    {
        ...
        $this->model = $this->objectManager->getObject(
            \Designnbuy\DesignReview\Model\ResourceModel\Review\Collection::class,
            [
    ...
    public function testAddEntityFilter(
        ...
        $this->selectMock->expects($this->exactly($callNum))
            ->method('join')
            ->with(
                'design_review_entity',
                'main_table.entity_id=' . 'design_review_entity' . '.entity_id',
                ['entity_code']
            );
    ...
    public function addEntityFilterDataProvider()
    {
        return [
            ...
            [
                'entity',
                2,
                ['design_review_entity.entity_code=?', 'entity'],
                ['main_table.entity_pk_value=?', 2],
                'quoteIntoReturn1',
                'quoteIntoReturn2',
                1
