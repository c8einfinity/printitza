...
namespace Designnbuy\DesignReview\Test\Unit\Block\Product;

use Magento\Framework\Registry;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Magento\Framework\View\Element\Template\Context;
use Magento\Catalog\Model\Product;
use Designnbuy\DesignReview\Block\Product\Review as ReviewBlock;
use Designnbuy\DesignReview\Model\ResourceModel\Review\Collection;
use Designnbuy\DesignReview\Model\ResourceModel\Review\CollectionFactory;
...
/**
 * Class ReviewTest
 * @package Designnbuy\DesignReview\Test\Unit\Block\Product
 */
class ReviewTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Designnbuy\DesignReview\Block\Product\Review
     */
    private $block;

    /**
     * @var \Designnbuy\DesignReview\Model\ResourceModel\Review\Collection|\PHPUnit_Framework_MockObject_MockObject
     */
    private $collection;

    /**
     * @var \Designnbuy\DesignReview\Model\ResourceModel\Review\CollectionFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @covers \Designnbuy\DesignReview\Block\Product\Review::getIdentities()
     */
    ...
    public function testGetProductReviewUrl($isSecure, $actionUrl, $productId)
    {
        $this->urlBuilder->expects($this->any())
            ->method('getUrl')
            ->with('designreview/product/listAjax', ['_secure' => $isSecure, 'id' => $productId])
