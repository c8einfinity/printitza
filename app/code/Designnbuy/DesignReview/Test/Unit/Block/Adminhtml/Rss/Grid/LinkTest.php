 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Block\Adminhtml\Rss\Grid;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;

/**
 * Class LinkTest
 * @package Designnbuy\DesignReview\Block\Adminhtml\Rss\Grid
 */
class LinkTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Designnbuy\DesignReview\Block\Adminhtml\Rss\Grid\Link
     */
    protected $link;
    ...
    protected function setUp()
    {
        ...
        $this->link = $this->objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Block\Adminhtml\Rss\Grid\Link::class,
            [
