...
namespace Designnbuy\DesignReview\Test\Unit\Block\Adminhtml;
...
{
    /**
     * @var \Designnbuy\DesignReview\Block\Adminhtml\Rss
     */
    protected $block;
    ...
    /**
     * @var \Designnbuy\DesignReview\Model\Rss|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $rss;
    ...
    protected function setUp()
    {
        ...
        $this->rss = $this->createPartialMock(\Designnbuy\DesignReview\Model\Rss::class, ['__wakeUp', 'getProductCollection']);
        $this->urlBuilder = $this->createMock(\Magento\Framework\UrlInterface::class);
        $this->objectManagerHelper = new ObjectManagerHelper($this);
        $this->block = $this->objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Block\Adminhtml\Rss::class,
            [
