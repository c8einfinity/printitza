 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Block\Adminhtml\Rating\Edit\Tab;
...
class FormTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Designnbuy\DesignReview\Model\ResourceModel\Rating\Option\Collection
     */
    protected $ratingOptionCollection;

    /**
     * @var \Designnbuy\DesignReview\Model\Rating\Option
     */
    ...
    /**
     * @var \Designnbuy\DesignReview\Model\Rating\OptionFactory
     */
    ...
    /**
     * @var \Designnbuy\DesignReview\Block\Adminhtml\Rating\Edit\Tab\Form
     */
    protected $block;
    ...
    protected function setUp()
    {
        $this->ratingOptionCollection = $this->createMock(
            \Designnbuy\DesignReview\Model\ResourceModel\Rating\Option\Collection::class
        );
        ...
        $this->rating = $this->createPartialMock(\Designnbuy\DesignReview\Model\Rating::class, ['getId', 'getRatingCodes']);
        $this->optionRating = $this->createMock(\Designnbuy\DesignReview\Model\Rating\Option::class);
        ...
        $this->optionFactory = $this->createPartialMock(\Designnbuy\DesignReview\Model\Rating\OptionFactory::class, ['create']);
        ...
        $this->block = $objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Block\Adminhtml\Rating\Edit\Tab\Form::class,
            [
