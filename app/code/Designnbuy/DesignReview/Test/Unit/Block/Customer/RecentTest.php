 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Block\Customer;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;

class RecentTest extends \PHPUnit\Framework\TestCase
{
    /** @var \Designnbuy\DesignReview\Block\Customer\Recent */
    protected $object;
    ...
    /** @var \Designnbuy\DesignReview\Model\ResourceModel\Review\Product\Collection|\PHPUnit_Framework_MockObject_MockObject */
    ...
    protected function setUp()
    {
        ...
        $this->collection = $this->createMock(\Designnbuy\DesignReview\Model\ResourceModel\Review\Product\Collection::class);
        ...
        $this->object = $this->objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Block\Customer\Recent::class,
            [
