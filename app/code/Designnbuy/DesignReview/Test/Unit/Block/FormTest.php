 ...
 */
namespace Designnbuy\DesignReview\Test\Unit\Block;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;

class FormTest extends \PHPUnit\Framework\TestCase
{
    /** @var \Designnbuy\DesignReview\Block\Form */
    protected $object;
    ...
    /**
     * @var \Designnbuy\DesignReview\Helper\Data|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->reviewDataMock = $this->getMockBuilder(\Designnbuy\DesignReview\Helper\Data::class)
        ...
        $this->object = $this->objectManagerHelper->getObject(
            \Designnbuy\DesignReview\Block\Form::class,
            [
    ...
    public function testGetAction($isSecure, $actionUrl, $productId)
    {
        $this->urlBuilder->expects($this->any())
            ->method('getUrl')
            ->with('designreview/product/post', ['_secure' => $isSecure, 'id' => $productId])
