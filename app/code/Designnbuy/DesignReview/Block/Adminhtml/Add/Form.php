 ...
 */
namespace Designnbuy\DesignReview\Block\Adminhtml\Add;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_name', 'note', ['label' => __('Design'), 'text' => 'product_name']);

        $fieldset->addField(
            'detailed-rating',
            'note',
            [
                'label' => __('Design Rating'),
                'required' => true,
        ...
        /*$gridFieldset = $form->addFieldset('add_review_grid', array('legend' => __('Please select a product')));
          ...
          'text' => $this->getLayout()->createBlock(\Designnbuy\DesignReview\Block\Adminhtml\Product\Grid::class)->toHtml(),
          ));*/

        $form->setMethod('post');
        $form->setUseContainer(true);
        $form->setId('edit_form');
        $form->setAction($this->getUrl('designreview/product/post'));
