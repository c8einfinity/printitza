...
use Designnbuy\DesignReview\Model\Rating\Option;
...
class Detailed extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Designnbuy_DesignReview::rating/detailed.phtml';
     ...
     *
     * @var \Designnbuy\DesignReview\Model\ResourceModel\Rating\CollectionFactory
     */
     ...
     * @param \Designnbuy\DesignReview\Model\ResourceModel\Rating\CollectionFactory $ratingsFactory
    ...
    public function __construct(
        ...
        \Designnbuy\DesignReview\Model\ResourceModel\Rating\CollectionFactory $ratingsFactory,
     ...
     *
     * @param Option $option
     * @param \Designnbuy\DesignReview\Model\Rating $rating
     * @return bool
