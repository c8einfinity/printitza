 ...
 */
namespace Designnbuy\DesignReview\Block\Adminhtml\Product;
...
class Grid extends \Magento\Catalog\Block\Adminhtml\Product\Grid
{
    ...
    {
        return $this->getUrl('designreview/product/productGrid', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('designreview/product/jsonProductInfo', ['id' => $row->getId()]);
    }
