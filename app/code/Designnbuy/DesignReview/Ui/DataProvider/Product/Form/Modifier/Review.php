 ...
 */
namespace Designnbuy\DesignReview\Ui\DataProvider\Product\Form\Modifier;
...
class Review extends AbstractModifier
{
    ...
    {
        if (!$this->locator->getProduct()->getId() || !$this->getModuleManager()->isOutputEnabled('Designnbuy_DesignReview')) {
            return $meta;
        }
