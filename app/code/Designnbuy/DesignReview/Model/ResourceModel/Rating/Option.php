...
class Option extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     * @param \Designnbuy\DesignReview\Model\Rating\Option\VoteFactory $ratingOptionVoteF
    ...
    public function __construct(
        ...
        \Designnbuy\DesignReview\Model\Rating\Option\VoteFactory $ratingOptionVoteF,
    ...
    {
        $this->_init('design_rating_option', 'option_id');

        $this->_reviewTable = $this->getTable('design_review');
        $this->_ratingOptionTable = $this->getTable('design_rating_option');
        $this->_ratingVoteTable = $this->getTable('design_rating_option_vote');
        $this->_aggregateTable = $this->getTable('design_rating_option_vote_aggregated');
        $this->_reviewStoreTable = $this->getTable('design_review_store');
        $this->_ratingStoreTable = $this->getTable('design_rating_store');
    }

    /**
     * Add vote
     *
     * @param \Designnbuy\DesignReview\Model\Rating\Option $option
     * @return $this
     */
