 ...
 */
namespace Designnbuy\DesignReview\Model\ResourceModel\Rating\Option\Vote;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Designnbuy\DesignReview\Model\Rating\Option\Vote::class,
            \Designnbuy\DesignReview\Model\ResourceModel\Rating\Option\Vote::class
        );
    }
    ...
    public function setStoreFilter($storeId)
    {
        ...
        $this->getSelect()->join(
            ['rstore' => $this->getTable('design_review_store')],
    ...
    public function addRatingInfo($storeId = null)
    {
        ...
        $ratingCodeCond = $connection->getIfNullSql('title.value', 'design_rating.rating_code');
        $this->getSelect()->join(
            ['design_rating' => $this->getTable('design_rating')],
            'design_rating.rating_id = main_table.rating_id',
            ['rating_code']
        )->joinLeft(
    ...
    {
        $this->getSelect()->join(
            ['rating_option' => $this->getTable('design_rating_option')],
    ...
    public function addRatingOptions()
    {
        ...
        foreach ($this->getItems() as $item) {
            /** @var \Designnbuy\DesignReview\Model\ResourceModel\Rating\Option\Collection $options */
