 ...
 */
namespace Designnbuy\DesignReview\Model\ResourceModel\Review\Product;
...
class Collection extends \Magento\Catalog\Model\ResourceModel\Product\Collection
{
    ...
    protected function _construct()
    {
        ...
        $this->_reviewStoreTable = $this->_resource->getTableName('design_review_store');
        $this->_initTables();
    }
    ...
    {
        $reviewTable = $this->_resource->getTableName('design_review');
        $reviewDetailTable = $this->_resource->getTableName('design_review_detail');
