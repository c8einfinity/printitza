 ...
 * Life is a code
 */
namespace Designnbuy\Merchandise\Controller\Category;
use Magento\Framework\Controller\ResultFactory;
/**
 * Category Service
 */
class Products extends \Designnbuy\Background\App\Action\Action
{
    /**
     * Store manager
     *
    ...
    public function execute()
    {
        ...
        try {
            $result = $this->_merchandise->getCategoryProducts($categoryId);
