 ...
 */
namespace Designnbuy\Sheet\App\Action;

/**
 * Sheet frontend action controller
 */
abstract class Action extends \Magento\Framework\App\Action\Action
{
    /**
     * Retrieve true if sheet extension is enabled.
     *
     * @return bool
     */
    protected function moduleEnabled()
    {
        return (bool) $this->getConfigValue(
            \Designnbuy\Sheet\Helper\Config::XML_PATH_EXTENSION_ENABLED,
