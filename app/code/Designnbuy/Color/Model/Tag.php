 ...
 * Tag model
 *
 * @method \Designnbuy\Color\Model\ResourceModel\Tag _getResource()
 * @method \Designnbuy\Color\Model\ResourceModel\Tag getResource()
...
class Tag extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'designnbuy_color_tag';
     ...
     * @var string
     */
    protected $_eventObject = 'color_tag';
    ...
    {
        $this->_init('Designnbuy\Color\Model\ResourceModel\Tag');
    }
