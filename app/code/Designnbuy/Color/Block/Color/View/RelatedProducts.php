...
/**
 * Color color related products block
 */
    ...
    implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $this->_itemCollection = $color->getRelatedProducts()
        ...
        $this->_itemCollection->setPageSize(
            (int) $this->_scopeConfig->getValue(
                'dnbcolor/color_view/related_products/number_of_products',
    ...
    public function displayProducts()
    {
        return (bool) $this->_scopeConfig->getValue(
            'dnbcolor/color_view/related_products/enabled',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        $color = $this->getColor();
        return $color ? [ \Magento\Cms\Model\Page::CACHE_TAG . '_relatedproducts_' . $color->getId() ] : [];
    }
}
