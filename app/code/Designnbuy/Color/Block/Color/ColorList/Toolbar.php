...
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'color/list/toolbar.phtml';
    ...
    /**
     * Get specified colors limit display per page
     *
     * @return string
     */
    public function getLimit()
    {
        return $this->_scopeConfig->getValue(
            'dnbcolor/color_list/colors_per_page', 
    ...
    {
        $pagerBlock = $this->getChildBlock('color_list_toolbar_pager');
