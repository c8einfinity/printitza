...
namespace Designnbuy\Color\Block\Color\ColorList\Toolbar;

use Designnbuy\Color\Model\Config\Source\LazyLoad;

/**
 * Color colors list toolbar pager
 */
class Pager extends \Magento\Theme\Block\Html\Pager
{
    ...
    public function getLazyloadMode()
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbcolor/color_list/lazyload_enabled',
    ...
    {
        return (int) $this->_scopeConfig->getValue(
            'dnbcolor/color_list/lazyload_padding',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
}
