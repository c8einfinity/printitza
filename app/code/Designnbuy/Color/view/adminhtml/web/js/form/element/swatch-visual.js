...
define([
     ...
     */
    function oldCode(value, container, uploadUrl, elementName, uid) {
        var swatchVisualOption = {
            ...
            initialize: function () {
                ...
                var colorValue = jQuery('#'+uid).val();
                if(colorValue != ''){
                    jQuery('#'+uid).css('background', colorValue);
                }
                jQuery(container).on(
                    'click',
                    '#'+uid,
            ...
            initColorPicker: function () {
                ...
                var colorValue = jQuery(element).val();
    ...
    return Abstract.extend({
        ...
        initOldCode: function () {
            jQuery.async('#' + this.uid, function (elem) {
                oldCode(this.value(), elem.parentElement, this.uploadUrl, this.inputName, this.uid);
            }.bind(this));
