...
namespace Designnbuy\Clipart\Block\Adminhtml\Grid\Column\Filter;
...
class Category extends \Magento\Backend\Block\Widget\Grid\Column\Filter\Select
{
     ...
     * @param \Designnbuy\Clipart\Model\ResourceModel\Category\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Context $context,
        \Magento\Framework\DB\Helper $resourceHelper,
        \Designnbuy\Clipart\Model\ResourceModel\Category\CollectionFactory $collectionFactory,
        array $data = []
    ) {
