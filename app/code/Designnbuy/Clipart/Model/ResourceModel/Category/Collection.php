...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Designnbuy\Clipart\Model\Category', 'Designnbuy\Clipart\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('designnbuy_clipart_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            ...
            $this->getSelect()->join(
                ['store_table' => $this->getTable('designnbuy_clipart_category_store')],
    ...
    public function addProductFilter($product)
    {
        ...
        if (!isset($this->_joinedFields['product'])) {
            $this->getSelect()->join(
                array('related_product' => $this->getTable('designnbuy_clipart_category_relatedproduct')),
                'related_product.category_id = main_table.category_id',
                array('related_product.position')
            );
