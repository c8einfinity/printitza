...
class Url
{
     ...
     * Objects Types
     */
    const CONTROLLER_CLIPART = 'clipart';
    ...
    public function getMediaUrl($file)
    {
        return $this->_storeManager->getStore()
            ->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . Clipart::BASE_MEDIA_URL. $file;
    }

    /**
     * Retrieve clipart permalink config value
     * @param  string $key
