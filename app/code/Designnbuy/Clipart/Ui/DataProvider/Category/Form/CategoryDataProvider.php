 ...
 * Life is a code
 */
namespace Designnbuy\Clipart\Ui\DataProvider\Category\Form;
...
class CategoryDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    /**
     * @var \Designnbuy\Clipart\Model\Category\ValueProvider
     */
    ...
    public function getData()
    {
        ...
        /** @var $category \Designnbuy\Clipart\Model\Category */
        foreach ($items as $category) {
            $category = $category->load($category->getId()); //temporary fix
            $data = $category->getData();
            /* Prepare related products */
            $collection = $category->getRelatedProducts()->addAttributeToSelect('name');
            $items = [];
