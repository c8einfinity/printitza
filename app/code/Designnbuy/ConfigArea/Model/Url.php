...
class Url
{
     ...
     * Objects Types
     */
    const CONTROLLER_CONFIGAREA = 'configarea';
    ...
    /**
     * Retrieve configarea permalink config value
     * @param  string $key
