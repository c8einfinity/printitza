 ...
 * Life is a code
 */
namespace Designnbuy\ConfigArea\App\Action;

/**
 * ConfigArea frontend action controller
 */
abstract class Action extends \Magento\Framework\App\Action\Action
{
    /**
     * Retrieve true if configarea extension is enabled.
     *
     * @return bool
     */
    protected function moduleEnabled()
    {
        return (bool) $this->getConfigValue(
            \Designnbuy\ConfigArea\Helper\Config::XML_PATH_EXTENSION_ENABLED,
