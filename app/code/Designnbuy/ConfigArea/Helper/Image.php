...
class Image extends AbstractHelper
{
    ...
    protected $_backgroundConfigArea = [255, 255, 255];
    protected $_baseFile;
    protected $_newFile;
    ...
    {
        if ($this->_baseFile){
            $path = 'configarea/cache/' . $width . 'x' . $height;
    ...
    protected function resizeBaseFile($width, $height)
    {
        ...
        $processor->backgroundConfigArea($this->_backgroundConfigArea);
