...
{
    const CODE_NO_OF_PAGES = 'no_of_pages';
    ...
    public function modifyData(array $data)
    {
        ...
        //$data[$productId][self::DATA_SOURCE_DEFAULT][self::CODE_SIDES_CONFIGURATION] = $items;
    ...
    protected function customizeAdvancedSides()
    {
        ...
        $this->meta = $this->arrayManager->merge(
            $this->arrayManager->findPath(
                static::CONTAINER_PREFIX . self::CODE_NO_OF_PAGES,
                $this->meta,
                null,
                'children'
            ),
