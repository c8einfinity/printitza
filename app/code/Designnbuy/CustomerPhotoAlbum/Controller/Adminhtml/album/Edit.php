...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Designnbuy_CustomerPhotoAlbum::Album')
            ->addBreadcrumb(__('Designnbuy CustomerPhotoAlbum'), __('Designnbuy CustomerPhotoAlbum'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Designnbuy\CustomerPhotoAlbum\Model\Album');
        ...
        $this->_coreRegistry->register('album', $model);
