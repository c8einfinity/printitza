...
class Fields extends AbstractModifier /*implements \MageWorx\OptionBase\Ui\DataProvider\Product\Form\Modifier\ModifierInterface*/
{
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $this->addDesignToolWeightTypeField();
    ...
    protected function addDesignToolWeightTypeField()
    {
        $groupCustomOptionsName =
            \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\CustomOptions::GROUP_CUSTOM_OPTIONS_NAME;
        $designToolTypeFields = $this->getDesignToolWeightTypeField();
    ...
    protected function getDesignToolWeightTypeField()
    {
        $fields = [
            'designtool_weight' => [
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'dataScope' => 'designtool_weight',
                            'dataType' => \Magento\Ui\Component\Form\Element\DataType\Text::NAME,
                            'fit' => true,
                            'options' => [
                                ['value'=>'fix', 'label'=> __('Fixed')],
                                ['value'=>'per_unit', 'label'=> __('Per Sq Unit')],
                            ],
                            'validation' => [
                                //'validate-text' => true,
