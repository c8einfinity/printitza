...
class Config extends \Magento\Framework\DataObject
{
     ...
     */
    const XML_PATH_ORDERTICKET_EMAIL = 'sales_email/designnbuy_orderticket';

    const XML_PATH_AUTH_EMAIL = 'sales_email/designnbuy_orderticket_auth';

    const XML_PATH_COMMENT_EMAIL = 'sales_email/designnbuy_orderticket_comment';

    const XML_PATH_CUSTOMER_COMMENT_EMAIL = 'sales_email/designnbuy_orderticket_customer_comment';
     ...
     */
    const XML_PATH_CUSTOMER_COMMENT_EMAIL_RECIPIENT = 'sales_email/designnbuy_orderticket_customer_comment/recipient';
    ...
    /**
     * Get root config path for ORDERTICKET Emails
     *
     * @return string
     */
    public function getRootOrderTicketEmail()
    {
        return self::XML_PATH_ORDERTICKET_EMAIL;
    }

    /**
     * Get root config path for ORDERTICKET Authorized Emails
     *
     * @return string
     */
