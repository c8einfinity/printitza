 ...
 */
namespace Designnbuy\OrderTicket\Block\Adminhtml\OrderTicket\Create\Order;

/**
 * Admin ORDERTICKET create order grid block
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        parent::_construct();
        $this->setId('designnbuy_orderticket_orderticket_create_order_grid');
     ...
     *
     * @return \Designnbuy\OrderTicket\Block\Adminhtml\OrderTicket\Create\Order\Grid
     */
