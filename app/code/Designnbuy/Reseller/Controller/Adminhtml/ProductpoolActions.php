 ...
 */
abstract class ProductpoolActions extends \Magento\Backend\App\Action
{
    /**
     * Form session key
     * @var string
    ...
    public function _filterProfileData(array $rawData)
    {
        $params = $rawData;
        if (isset($params['profile_image'][0]['name'])) {
            $params['profile_image'] = $params['profile_image'][0]['name'];
