 ...
 * ColorCounter model
 *
 * @method \Designnbuy\PrintingMethod\Model\ResourceModel\ColorCounter _getResource()
 * @method \Designnbuy\PrintingMethod\Model\ResourceModel\ColorCounter getResource()
 ...
 */
class ColorCounter extends \Magento\Framework\Model\AbstractModel
{
    /**
     * ColorCounters's Statuses
     */
     ...
     */
    const BASE_MEDIA_PATH = 'designnbuy'. DIRECTORY_SEPARATOR .'ColorCounter';
     ...
     * @var string
     */
    protected $_eventPrefix = 'designnbuy_printingmethod_colorcounter';
     ...
     * @var string
     */
    protected $_eventObject = 'printingmethod_colorcounter';
    ...
    /**
     * @var \Designnbuy\PrintingMethod\Model\ResourceModel\ColorCounter\Collection
     */
    protected $_relatedColorCountersCollection;
    ...
    public function __construct(
        ...
        $this->_relatedColorCountersCollection = clone($this->getCollection());
    }
    ...
    {
        $this->_init('Designnbuy\PrintingMethod\Model\ResourceModel\ColorCounter');
    }
    ...
    {
        return $plural ? 'Color Counters' : 'Color Counter';
    }

    /**
     * Retrieve true if colorcounter is active
    ...
    /**
     * Retrieve available colorcounter statuses
     * @return array
     */
    ...
    /**
     * Check if colorcounter identifier exist for specific store
     * return colorcounter id if colorcounter exists
     *
    ...
    /**
     * Retrieve colorcounter url route path
     * @return string
     */
    ...
    /**
     * Retrieve colorcounter url
     * @return string
     */
    public function getColorCounterUrl()
    {
        if (!$this->hasData('colorcounter_url')) {
            $url = $this->_url->getUrl($this, URL::CONTROLLER_PRINTINGMETHOD);
            $this->setData('colorcounter_url', $url);
        }

        return $this->getData('colorcounter_url');
    }
    ...
    {
        if (!$this->hasData('colorcounter_image')) {
            if ($file = $this->getData('image')) {
                $image = $this->_url->getMediaUrl($file);
            } else {
                $image = false;
            }
            $this->setData('colorcounter_image', $image);
        }

        return $this->getData('colorcounter_image');
    }
    ...
    /**
     * Retrieve colorcounter related products
    ...
    public function getRelatedProducts()
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('designnbuy_printingmethod_colorcounter_relatedproduct')],
    ...
    /**
     * Retrieve colorcounter publish date using format
     * @param  string $format
     * @return string
     */
    ...
    /**
     * Temporary method to get images from some custom colorcounter version. Do not use this method.
     * @param  string $format
     * @return string
     */
    public function getColorCounterImage()
    {
        $image = $this->getData('image');
        if (!$image) {
            $image = $this->getData('colorcounter_image');
        }
        return $image;
    }
    ...
    /**
     * Duplicate colorcounter and return new object
     * @return self
     */
