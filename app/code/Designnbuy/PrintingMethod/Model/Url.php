...
class Url
{
     ...
     * Objects Types
     */
    const CONTROLLER_PRINTINGMETHOD = 'printingmethod';
    ...
    {
        foreach([
            self::CONTROLLER_PRINTINGMETHOD,
    ...
    /**
     * Retrieve printingmethod base url
     * @return string
     */
    ...
    /**
     * Retrieve printingmethod page url
    ...
    /**
     * Retrieve printingmethod url path
     * @param  string $identifier
     * @param  string $controllerName
     * @return string
     */
    ...
    /**
     * Retrieve printingmethod permalink config value
     * @param  string $key
    ...
    protected function _getConfig($key)
    {
        return $this->_scopeConfig->getValue(
            'dnbprintingmethod/permalink/'.$key,
