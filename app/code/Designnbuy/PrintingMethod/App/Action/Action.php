 ...
 * Life is a code
 */
namespace Designnbuy\PrintingMethod\App\Action;

/**
 * PrintingMethod frontend action controller
 */
abstract class Action extends \Magento\Framework\App\Action\Action
{
    /**
     * Retrieve true if printingmethod extension is enabled.
     *
     * @return bool
     */
    protected function moduleEnabled()
    {
        return (bool) $this->getConfigValue(
            \Designnbuy\PrintingMethod\Helper\Config::XML_PATH_EXTENSION_ENABLED,
