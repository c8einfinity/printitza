 ...
 */
class QuantityAreaPrice implements ModifierInterface
{
    /**
     ...
     * SquareArea factory
     *
     * @var \Designnbuy\PrintingMethod\Model\SquareAreaFactory
     */
    ...
    public function __construct(
        ...
        \Designnbuy\PrintingMethod\Model\SquareAreaFactory $_areaFactory
    ) {
        ...
        $this->_areaFactory = $_areaFactory;
    }
            ...
            [
                'quantity_area_price' => [
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label' => __('Related Quantity Area Price'),
                                'collapsible' => true,
                                'componentType' => Fieldset::NAME,
                                'dataScope' => '',
                                'sortOrder' => 110,
                                'visibleByPricingLogic' => 3,
                                'dependsOn' => 'pricing_logic',
                            ],
                        ],
                    ],
                    'children' => [
                        'qaprice' => $this->getGridConfig(10),
                    ]
                ],
            ]
        );
    ...
    protected function getAreaFieldConfig($sortOrder)
    {
        return [
            'squarearea_id' => [
                'arguments' => [
    ...
    {
        $collection = $this->_areaFactory->create()->getResourceCollection();
        $options = $collection->toOptionArray();
        return $options;
    }
