 ...
 */
namespace Designnbuy\PrintingMethod\Block\Adminhtml\PrintingMethod\Edit\Tab;

class Labels extends \Magento\Backend\Block\Widget\Form\Generic implements
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    /**
     * @var \Designnbuy\PrintingMethod\Model\CategoryFactory
     */
     ...
     * @param \Designnbuy\PrintingMethod\Model\CategoryFactory $categoryFactory
     * @param array $data
     */
    ...
    {
        $category = $this->printingmethodFactory->create();
                ...
                foreach ($stores as $store) {
                    $fieldset->addField(
                        ...
                        [
                            ...
                            'data-form-part' => 'printingmethod_printingmethod_form'
                        ]
                    );
                }
            }
