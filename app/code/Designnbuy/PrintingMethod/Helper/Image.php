...
class Image extends AbstractHelper
{
    ...
    protected $_backgroundPrintingMethod = [255, 255, 255];
    protected $_baseFile;
    protected $_newFile;
    ...
    {
        if ($this->_baseFile){
            $path = 'printingmethod/cache/' . $width . 'x' . $height;
    ...
    protected function resizeBaseFile($width, $height)
    {
        ...
        $processor->backgroundColor($this->_backgroundPrintingMethod);
