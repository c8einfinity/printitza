...
Line = (function(superClass) {
  ...
  Line.prototype.formatText = function(offset, length, name, value) {
    var format, leaf, leafOffset, leftNode, nextLeaf, ref, ref1, ref2, rightNode, targetNode, firstNode;
  ...
  Keyboard.prototype._initEnter = function() {
    ...
    return this.addHotkey(keys, (function(_this) {
      return function(range, hotkey) {
        ...
        var text_to_insert = '\n';
        if(offset == line.length-1) {//if its end of line
          text_to_insert = '\n ';
        }
        delta = new Delta().retain(range.start).insert(text_to_insert, leaf.formats)["delete"](range.end - range.start);
        _this.quill.updateContents(delta, Quill.sources.USER);
        if(text_to_insert == '\n ') {//if its end of line
          _this.quill.setSelection(range.start + 1, range.start + 2);
        }
  ...
  PasteManager.prototype._paste = function() {
    ...
    return _.defer((function(_this) {
      return function() {
        ...
        //removing formats
        if(delta.ops.length){
          _.each(delta.ops, (function(item) {
