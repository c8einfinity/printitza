 ...
 */
class RemoveWhite extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (isset($params['option']) && $params['option'] == 'edges') {
                $result = $this->dnbBaseHelper->removeWhiteFromEdges($params);
            } else {
