...
/**
 * Template templates list toolbar
 */
class Toolbar extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'template/list/toolbar.phtml';
    ...
    /**
     * Get specified templates limit display per page
     *
     * @return string
     */
    public function getLimit()
    {
        return $this->_scopeConfig->getValue(
            'dnbtemplate/template_list/templates_per_page', 
    ...
    {
        $pagerBlock = $this->getChildBlock('template_list_toolbar_pager');
