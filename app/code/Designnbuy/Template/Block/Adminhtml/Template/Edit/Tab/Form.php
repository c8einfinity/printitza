...
namespace Designnbuy\Template\Block\Adminhtml\Template\Edit\Tab;
...
//class Form extends \Magento\Catalog\Block\Adminhtml\Form
{
    ...
    {
        return [
            'image' => 'Designnbuy\Template\Block\Adminhtml\Template\Helper\Image'
        ];
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Template Details')]);

        $attributes = $this->getAttributes();

        $entity = $this->getEavConfig()->getEntityType(\Designnbuy\Template\Model\Template::ENTITY)->getEntity();
