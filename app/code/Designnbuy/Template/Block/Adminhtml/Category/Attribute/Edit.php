 ...
 *
 */
namespace Designnbuy\Template\Block\Adminhtml\Category\Attribute;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Designnbuy_Template';
    ...
    protected function _construct()
    {
        ...
        $this->_controller = 'adminhtml_template_attribute';
        ...
        if (!$entityAttribute || !$entityAttribute->getIsUserDefined()
                || !$this->_isAllowedAction('Designnbuy_Template::attribute_delete')) {
    ...
    public function getHeaderText()
    {
       if ($this->_coreRegistry->registry('customer_attribute')->getId()) {
            ...
            return __('Edit Template Attribute "%1"', $this->escapeHtml($frontendLabel));
        }
        return __('New Template Attribute');
    }
