 ...
 */
namespace Designnbuy\Template\Model\Category\Attribute;
 ...
 */
class Repository implements \Designnbuy\Template\Api\Category\CategoryAttributeRepositoryInterface
{
    /**
    ...
    public function get($attributeCode)
    {
        return $this->eavAttributeRepository->get(
            \Designnbuy\Template\Api\Data\Category\CategoryAttributeInterface::ENTITY_TYPE_CODE,
            $attributeCode
        );
    }
