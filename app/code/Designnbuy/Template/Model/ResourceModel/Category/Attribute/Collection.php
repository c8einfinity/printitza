 ...
 */
namespace Designnbuy\Template\Model\ResourceModel\Category\Attribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
    ...
    protected function _initSelect()
    {
        $entityTypeId = (int)$this->_eavEntityFactory->create()->setType(
            \Designnbuy\Template\Model\Category::ENTITY
        )->getTypeId();
        ...
        $this->getSelect()->from(
            ...
            ['additional_table' => $this->getTable('designnbuy_template_eav_attribute')],
