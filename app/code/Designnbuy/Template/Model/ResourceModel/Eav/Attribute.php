...
namespace Designnbuy\Template\Model\ResourceModel\Eav;
...
class Attribute extends \Magento\Eav\Model\Entity\Attribute implements
    \Designnbuy\Template\Api\Data\TemplateAttributeInterface, \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface
{
    const MODULE_NAME = 'Designnbuy_Template';
    ...
    {
        $this->_init('Designnbuy\Template\Model\ResourceModel\Attribute');
    }
