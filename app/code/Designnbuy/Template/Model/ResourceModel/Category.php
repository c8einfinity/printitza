...
class Category extends AbstractResource
{
    ...
    public function __construct(
        ...
        $this->setType(\Designnbuy\Template\Model\Category::ENTITY);
     ...
     *
     * @param Designnbuy\Template\Model\Category $category
     * @return $this
     */
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds, $websiteIds, $isActive = null)
    {
        /*$select = $this->getConnection()->select()->from(
            ['cp' => $this->getTable('designnbuy_template_category_entity')]
        )->join(
            ['cps' => $this->getTable('designnbuy_template_category_website')],
        ...
        $urlRewrite = $this->eavConfig->getAttribute('designnbuy_template_category', 'identifier');
        if (!$urlRewrite || !$urlRewrite->getId()) {
            return false;
        }
        $identifierTable = $urlRewrite->getBackend()->getTable();

        $status = $this->eavConfig->getAttribute('designnbuy_template_category', 'status');
    ...
    public function getCategoryWebsiteTable()
    {
        if (!$this->_categoryWebsiteTable) {
            $this->_categoryWebsiteTable = $this->getTable('designnbuy_template_category_website');
        }
    ...
    protected function _beforeSave(\Magento\Framework\DataObject $object)
    {
        ...
        $identifierGenerator = \Magento\Framework\App\ObjectManager::getInstance()
            ->create('Designnbuy\Template\Model\ResourceModel\PageIdentifierGenerator');
