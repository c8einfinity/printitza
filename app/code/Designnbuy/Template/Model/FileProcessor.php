...
class FileProcessor
{
    ...
    {
        $filePath = \Designnbuy\Template\Helper\Template::BASE_MEDIA_PATH . '/' . ltrim($fileName, '/');
    ...
    public function getViewUrl($filePath, $type)
    {
        $viewUrl = '';
            ...
            $filePath = \Designnbuy\Template\Helper\Template::BASE_MEDIA_PATH . '/' . ltrim($filePath, '/');
    ...
    public function saveTemporaryFile($fileId)
    {
        ...
        $path = $this->mediaDirectory->getAbsolutePath(
            \Designnbuy\Template\Helper\Template::BASE_MEDIA_PATH . '/' . self::TMP_DIR
        );
