...
class Action extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init(\Designnbuy\Template\Model\ResourceModel\Template\Action::class);
    }
     ...
     * @return $this
     */
    public function updateAttributes($templateIds, $attrData, $storeId)
    {
        $this->_getResource()->updateAttributes($templateIds, $attrData, $storeId);
        /*$this->setData(
