 ...
 */
class Save extends \Designnbuy\Template\Controller\Adminhtml\Category\Attribute\Attribute
{
    /**
...
//            }
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('template/category_attribute/*/', [], ['error' => true]);
                }
            ...
            $defaultAttributeSetId = $this->_objectManager->get('Magento\Eav\Model\Config')
                    ->getEntityType(\Designnbuy\Template\Model\Category\Attribute::ENTITY)
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the template category attribute.'));

                $this->_session->setAttributeData(false);
                if ($this->getRequest()->getParam('back', false)) {
                    return $this->returnResult(
                        'template/category_attribute/edit',
