...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Designnbuy_Template::category_attributes')
            ->addBreadcrumb(__('Template Attributes'), __('Template Category Attributes'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Template Category Attributes'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $item = $id ? __('Edit Template Category Attribute') : __('New Template Category Attribute');

        $resultPage = $this->createActionPage($item);
        $resultPage->getConfig()->getTitle()->prepend($id ? $model->getName() : __('New Template Category Attribute'));
    ...
    protected function createActionPage($title = null)
    {
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $resultPage->addBreadcrumb(__('Template'), __('Template Category'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Template Category Attributes'))
            ->setActiveMenu('Designnbuy_Template::category_attributes');
        if (!empty($title)) {
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $this->_entityTypeId = $this->_objectManager->create(
            ...
            \Designnbuy\Template\Model\Category\Attribute::ENTITY
        )->getTypeId();
