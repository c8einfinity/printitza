...
class Delete extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Designnbuy_Template::attribute_delete');
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                $model = $this->_objectManager->create('Designnbuy\Template\Model\ResourceModel\Eav\Attribute');
                $model->load($id);
                $model->delete();
