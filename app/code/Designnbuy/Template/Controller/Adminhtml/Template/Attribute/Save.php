<?php
/**
 * Template attribute save controller
 * 
 */
 ...
 */
class Save extends \Designnbuy\Template\Controller\Adminhtml\Template\Attribute\Attribute
{
    /**
     ...
     * @param \Designnbuy\Template\Helper\Data $attributeHelper
    ...
    public function __construct(
        ...
        \Designnbuy\Template\Helper\Data $attributeHelper,
...
//            }
            ...
            $model = $this->_objectManager->create(
                'Designnbuy\Template\Model\ResourceModel\Eav\Attribute'
                );
            ...
            if ($attributeId) {
                ...
                if (!$model->getId()) {
                    ...
                    return $this->returnResult('template/template_attribute/*/', [], ['error' => true]);
                }
            ...
            $defaultAttributeSetId = $this->_objectManager->get('Magento\Eav\Model\Config')
                    ->getEntityType(\Designnbuy\Template\Model\Template\Attribute::ENTITY)
            ...
            try {
                $model->save();
                $this->messageManager->addSuccess(__('You saved the template attribute.'));

                $this->_session->setAttributeData(false);
                if ($this->getRequest()->getParam('back', false)) {
                    return $this->returnResult(
                        'template/template_attribute/edit',
                        ['attribute_id' => $model->getId(), '_current' => true],
                        ['error' => false]
                    );
                }
                return $this->returnResult('template/attribute/*/', [], ['error' => false]);
            } catch (\Exception $e) {
