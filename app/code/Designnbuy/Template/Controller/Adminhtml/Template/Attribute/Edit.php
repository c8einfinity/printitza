...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Designnbuy_Template::template_attributes')
            ->addBreadcrumb(__('Template Attributes'), __('Template Attributes'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Template Attributes'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $item = $id ? __('Edit Template Attribute') : __('New Template Attribute');

        $resultPage = $this->createActionPage($item);
        $resultPage->getConfig()->getTitle()->prepend($id ? $model->getName() : __('New Template Attribute'));
    ...
    protected function createActionPage($title = null)
    {
        ...
        $resultPage->addBreadcrumb(__('Template'), __('Template'))
            ->addBreadcrumb(__('Manage Customer Attributes'), __('Manage Template Attributes'))
            ->setActiveMenu('Designnbuy_Template::template_attributes');
        if (!empty($title)) {
    ...
    public function dispatch(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $this->_entityTypeId = $this->_objectManager->create(
            ...
            \Designnbuy\Template\Model\Template\Attribute::ENTITY
        )->getTypeId();
