...
class System extends AbstractModifier
{
    ...
    protected $categoryUrls = [
        self::KEY_SUBMIT_URL => 'template/category/save',
        //self::KEY_VALIDATE_URL => 'template/template/validate',
        self::KEY_RELOAD_URL => 'template/category/reload'
    ];
    ...
    {
        $model = $this->locator->getTemplateCategory();
        ...
        $reloadParameters = array_merge(
            ...
            [
                ...
                'type' => $this->locator->getTemplateCategory()->getTypeId()
            ]
        );
