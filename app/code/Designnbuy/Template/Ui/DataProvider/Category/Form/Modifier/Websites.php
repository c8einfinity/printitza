...
class Websites extends AbstractModifier
{
    ...
    {
        $modelId = $this->locator->getTemplateCategory()->getId();
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'label' => __('Category in Websites'),
                                    'collapsible' => true,
                                    'componentType' => Form\Fieldset::NAME,
                                    'dataScope' => self::DATA_SCOPE_CATEGORY,
                                    'disabled' => false,
    ...
    protected function getFieldsForFieldset()
    {
        ...
        $isNewProduct = !$this->locator->getTemplateCategory()->getId();
        $tooltip = [
    ...
    /**
     * Return array of websites ids, assigned to the category
     *
     * @return array
     */
    protected function getWebsitesValues()
    {
        return $this->locator->getCategoryWebsiteIds();
    }
}
