...
use \Designnbuy\Template\Model\Category as CategoryModel;
use Magento\Framework\UrlInterface;
use Magento\Framework\Stdlib\ArrayManager;
use Designnbuy\Template\Model\CategoryTree;

/**
 * Data provider for categories field of template page
...
class Categories extends AbstractModifier
{
     ...
     */
    const CATEGORY_TREE_ID = 'TEMPLATE_CATEGORY_TREE';
    /**#@-*/
                            ...
                            'data' => [
                                'config' => [
                                    ...
                                    'render_url' => $this->urlBuilder->getUrl(
                                        ...
                                        [
                                            'handle' => 'template_category_create',
                                            'store' => $this->locator->getStore()->getId(),
                                            'buttons' => 1
                                        ]
                                    ),
                                    'autoRender' => false,
                                    'ns' => 'template_category_new_category_form',
                                    'externalProvider' => 'template_category_new_category_form.template_category_new_category_form_data_source',
    ...
    {
        $fieldCode = 'path';
        //$meta['general']['children'][static::CONTAINER_PREFIX . $fieldCode] = [];
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'actions' => [
                                        [
                                            'targetName' => 'template_form.template_form.create_category_modal',
                                            'actionName' => 'toggleModal',
                                        ],
                                        [
                                            'targetName' =>
                                                'template_form.template_form.create_category_modal.create_category',
                                            'actionName' => 'render'
                                        ],
                                        [
                                            'targetName' =>
    ...
    protected function getCategoriesTree($filter = null)
    {
        ...
        $collection->addAttributeToSelect(['title', 'is_active', 'path', 'parent_id'])
            ->setStoreId($storeId);
           // ->setStoreId($storeId);
    ...
    {
        $childs =  $this->categoryTree->getChilds();
        $options = [];
