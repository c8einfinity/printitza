...
abstract class Actions extends \Magento\Backend\App\Action
{
     ...
     * @param RedemptionDataProcessor $dataProcessor
    ...
    public function __construct(
        ...
        \Designnbuy\Commission\Helper\Data $redemptionHelper
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->request = $request;
        $this->redemptionHelper = $redemptionHelper;  
    ...
    protected function _indexAction()
    {
        ...
        $title = __('%1', $this->_getModel(false)->getOwnTitle(true));
