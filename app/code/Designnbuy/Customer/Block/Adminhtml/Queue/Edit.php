...
class Edit extends \Magento\Backend\Block\Template
{
    ...
    /**
     * Retrieve current Customer Queue Object
     *
     * @return ModelQueue
     */
    ...
    protected function _beforeToHtml()
    {
        $this->setChild(
            'form',
            $this->getLayout()->createBlock('Designnbuy\Customer\Block\Adminhtml\Queue\Edit\Form', 'form')
        );
    ...
    /**
     * Getter for check is this customer the plain text.
     *
     * @return bool
     * @SuppressWarnings(PHPMD.BooleanGetMethodName)
     */
    ...
    {
        return $this->getIsPreview() ? __('View Customer') : __('Edit Customer');
    }
}
