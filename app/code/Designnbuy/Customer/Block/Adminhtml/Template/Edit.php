...
//        }
    ...
    {
        if ($this->getEditMode()) {
            return __('Edit Customer Template');
        }

        return __('New Customer Template');
    }
    ...
    {
        return $this->getLayout()->createBlock('Designnbuy\Customer\Block\Adminhtml\Template\Edit\Form')->toHtml();
    }
