...
/**
 * Customer design grid block
 *
 * @author      Magento Core Team <core@magentocommerce.com>
 */
namespace Designnbuy\Customer\Block\Adminhtml;

use Designnbuy\Customer\Model\ResourceModel\Queue\Collection;
...
class Design extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'design/list.phtml';
     ...
     * @param \Designnbuy\Customer\Model\ResourceModel\Queue\CollectionFactory $collectionFactory
     * @param array $data
     */
    public function __construct(
        \Magento\Backend\Block\Template\Context $context,
        \Designnbuy\Customer\Model\ResourceModel\Queue\CollectionFactory $collectionFactory,
        array $data = []
    ) {
    ...
    public function getQueueCollection()
    {
        if ($this->_queueCollection === null) {
            /** @var $this->_queueCollection \Designnbuy\Customer\Model\ResourceModel\Queue\Collection */
