...
class CustomerGroupDesignideaFilter
{
    protected $session;
	...
	public function afterGetDesignideaCollection(\Designnbuy\Designidea\Block\Designidea\DesignideaList\AbstractList $subject, $result)
	{
