...
class Pause extends \Designnbuy\Customer\Controller\Adminhtml\Queue
{
    /**
     * Pause Customer queue
     *
     * @return void
     */
    public function execute()
    {
        ...
        $queue->setQueueStatus(\Designnbuy\Customer\Model\Queue::STATUS_PAUSE);
        $queue->save();
