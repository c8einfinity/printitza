 ...
 */
class CreateFromTool extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($confirmationStatus === AccountManagementInterface::ACCOUNT_CONFIRMATION_REQUIRED) {
                ...
                $customerData = $this->_customerRepositoryInterface->load($customer->getId());
                $customerData->setAccountIsActive(1);
                $customerData->save();
                $this->session->setCustomerDataAsLoggedIn($customer);
                $response['id'] = $customer->getId();
                $response['status'] = 'true';
                $response['user_name'] = $customer->getFirstName()." ".$customer->getLastName();
                $response['error'] = $this->getSuccessMessage();
            }
            ...
            $response['status'] = 'false';
            $response['error'] =  __('We can\'t save the customer.');
        }
