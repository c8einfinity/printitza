 ...
 */
namespace Designnbuy\Customer\Model\ResourceModel\Design;

use Designnbuy\Customer\Model\Queue as ModelQueue;

/**
 * Customer designs collection
 *
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Designnbuy\Customer\Model\Design', 'Designnbuy\Customer\Model\ResourceModel\Design');
        $this->_queueLinkTable = $this->getTable('designnbuy_customer_queue_link');
    ...
    /**
     * Set loading mode designs by queue
     *
    ...
    public function useQueue(ModelQueue $queue)
    {
        $this->getSelect()->join(
            ...
            "link.design_id = main_table.design_id",
            []
        )->where(
            "link.queue_id = ? ",
            $queue->getId()
    ...
    /**
     * Set using of links to only unsendet letter designs.
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function addDesignTypeField()
    {
    ...
    public function useOnlySubscribed()
    {
        $this->addFieldToFilter(
            'main_table.design_status',
            \Designnbuy\Customer\Model\Design::STATUS_SUBSCRIBED
        );
