...
/**
 * Customer template resource model
 *
...
class Template extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('customer_template', 'template_id');
    }
     ...
     * @return boolean
     */
    public function checkUsageInQueue(\Designnbuy\Customer\Model\Template $template)
    {
        if ($template->getTemplateActual() !== 0 && !$template->getIsSystem()) {
            $select = $this->getConnection()->select()->from(
                $this->getTable('designnbuy_customer_queue'),
     ...
     * @return boolean
     */
    public function checkCodeUsage(\Designnbuy\Customer\Model\Template $template)
    {
