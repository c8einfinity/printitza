        ...
        if ($id) {
            ...
            if (!$model->getId()) {
                ...
                if($accountType == 'activate'):
                    ...
                    $model->save();
                    $this->messageManager->addSuccessMessage(__('You activate this Workflow user successfully.'));
                else:
                    $adminUserModel->load($model->getUserId());
                    $this->_resources = \Magento\Framework\App\ObjectManager::getInstance()->get('Magento\Framework\App\ResourceConnection');          
                    $connection = $this->_resources->getConnection();
                    ...
                    $model->save();
                    $this->messageManager->addSuccessMessage(__('You inactive this Workflow user successfully.'));
                endif;
            }
