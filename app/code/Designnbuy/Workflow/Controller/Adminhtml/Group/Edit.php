...
class Edit extends \Designnbuy\Workflow\Controller\Adminhtml\Group
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('designnbuy_workflow_group', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getGroupId() ? $model->getData('title') : __('New Group'));
        return $resultPage;
    }
}
