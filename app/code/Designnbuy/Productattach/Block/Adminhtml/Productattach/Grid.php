<?php
namespace Designnbuy\Productattach\Block\Adminhtml\Productattach;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Designnbuy\Productattach\Model\Productattach $productattachPage
    ...
    public function __construct(
        ...
        \Designnbuy\Productattach\Model\Productattach $productattach,
    ...
    public function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('File'),
                'index' => 'file',
                'renderer' => 'Designnbuy\Productattach\Block\Adminhtml\Productattach\Renderer\FileIcon'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Designnbuy\Productattach\Block\Adminhtml\Productattach\Renderer\Group'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Store '),
                'index' => 'store',
                'renderer' => 'Designnbuy\Productattach\Block\Adminhtml\Productattach\Renderer\Store'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Active'),
                'index' => 'active',
                'renderer' => 'Designnbuy\Productattach\Block\Adminhtml\Productattach\Renderer\Active'
            ]
        );
