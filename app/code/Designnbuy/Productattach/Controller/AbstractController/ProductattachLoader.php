...
class ProductattachLoader implements ProductattachLoaderInterface
{
    ...
    /**
     * @param \Designnbuy\Productattach\Model\ProductattachFactory $productattachFactory
     * @param OrderViewAuthorizationInterface $orderAuthorization
     * @param Registry $registry
     * @param \Magento\Framework\UrlInterface $url
     */
    public function __construct(
        \Designnbuy\Productattach\Model\ProductattachFactory $productattachFactory,
        Registry $registry,
