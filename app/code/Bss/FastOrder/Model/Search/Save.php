...
class Save
{
    ...
    public function getProductInfo($inputRes = null, $csv = null)
    {
        ...
        $collection ->addAttributeToSelect('*')
                    ...
                    ->addUrlRewrite()
                    ->addAttributeToFilter('is_fastorder_allowed', 1)
        ...
        foreach ($collection as $product) {
            ...
            $allowattachment = $product->getAllowattachment();
            $absolute_price = $product->getAbsolutePrice();
	...
	public function getFastorderProductsInfo()
    {
        $image = 'category_page_grid';
        $data = '';
        $maxRes = 5;
