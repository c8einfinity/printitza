define([
    ...
    $.widget('bss.fastorder', {
        ...
        _resetRow: function (el,data) {
            ...
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-ref .bss-search-input').val('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-image').text(' ');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty input.qty').val(1);
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty input.qty').attr('readonly', 'readonly');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-price-number').val('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-price-number-download').val(0);
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-price-custom-option').val(0);
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-price-absolute-price').val('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-id-calc').val('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-qty .bss-product-qty-increment').text('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-attachment .product-options').hide();
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-price span.price').text('');
            $(el).closest('.bss-fastorder-row').find('.bss-fastorder-row-name').html('<div class="bss-product-name-select"></div><div class="bss-product-option-select"><ul></ul></div><div class="bss-product-custom-option-select"><ul></ul></div><div class="bss-product-baseprice"><ul></ul></div>');
        ...
        _reloadTotalPrice: function (el,fomatPrice) {
            var totalPrice,
                ...
                get_absolute_price = $(el).closest('.bss-fastorder-row-qty').find('.bss-product-price-absolute-price').val(),
                ...
                for (var key in obj) {
                    ...
                    if (typeof obj[key]['final_price'] != 'object') {
                        if (parseFloat(qtyTotal) >= parseFloat(key)) {
                            if(get_absolute_price == 1){
                                price = parseFloat(priceOption) + parseFloat(downloadOption);
                            } else {
