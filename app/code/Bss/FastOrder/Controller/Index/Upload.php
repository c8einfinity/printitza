    ...
    public function execute()
    {
        try {
            ...
            if($result = $uploader->save($path)) {
                ...
                $result['attachment_filename'] = "attachment[fileName][".$this->getRequest()->getParam("sort_order")."][]";
                $result['attachment_fileUrl'] = "attachment[fileUrl][".$this->getRequest()->getParam("sort_order")."][]";
            }
