...
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    public function execute()
    {
		...
		$filesdata = '';
		if($this->getRequest()->getParam('filesdata'))
		{	$filesdata = $this->getRequest()->getParam('filesdata');	}
        ...
        try {
            ...
            foreach ($productIds as $key => $productId) {
                ...
                if(isset($attachment['fileName'][$key])){
                    foreach($attachment['fileName'][$key] as $fileData){
                        $params['attachment']['fileName'][] = $fileData;
                    }
                }
                if(isset($attachment['fileUrl'][$key])){
                    foreach($attachment['fileUrl'][$key] as $fileUrlData){
                        $params['attachment']['fileUrl'][] = $fileUrlData;
                    }
                }
