...
class Select extends CatalogSelect
{
    ...
    protected function getTypeMultiple($_option = null, $store = null, $configValue = null, $sortOrder = null)
    {
        ...
        $specialPriceModel = $objectManager->create('MageWorx\OptionAdvancedPricing\Model\SpecialPrice');
        ...
        $select = $this->getLayout()->createBlock(
            ...
            [
                ...
                'class' => $require . ' product-custom-option '.$_option->getDesigntoolType().' admin__control-select'
            ]
        );
        if ($_option->getType() == Option::OPTION_TYPE_DROP_DOWN) {
        ...
        foreach ($_option->getValues() as $_value) {
            ...
            $select->addOption(
                ...
                ['price' => $this->pricingHelper->currencyByStore($_value->getPrice(true), $store, false), 'fast_price' =>  $specialPriceModel->getActualSpecialPrice($_value)]
            );
        }
