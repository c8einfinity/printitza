...
class HolidaysActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * Url path  to edit
     *
     * @var string
     */
    const URL_PATH_EDIT = 'drc_storepickup/holidays/edit';
     ...
     * @var string
     */
    const URL_PATH_DELETE = 'drc_storepickup/holidays/delete';
